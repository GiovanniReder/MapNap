        ...
        <Row>
          <Col md={4}>
            <Card className="mx-2 my-3">
              ...
              <Card.Body>
                <Card.Text>
                  <p>Sicurezza e sorveglianza:</p> I campeggi spesso dispongono di personale che monitora l'area,
                  riducendo il rischio di incontri indesiderati con animali selvatici o individui malintenzionati.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4}>
            <Card className="mx-2 my-3">
              ...
              <Card.Body>
                <Card.Text>
                  <p>Comodità e infrastrutture:</p>I campeggi offrono comfort e infrastrutture non facilmente trovabili
                  in natura, come servizi igienici, elettricità, acqua corrente, aree picnic, cucine condivise e zone
                  barbecue.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col md={4}>
            <Card className="mx-2 my-3">
              ...
              <Card.Body>
                <Card.Text>
                  <p>Socializzazione:</p>Nei campeggi è possibile socializzare con persone con interessi simili e
                  partecipare a varie attività ricreative organizzate, come escursioni, giochi per bambini e serate a
                  tema.
                </Card.Text>
              </Card.Body>
            </Card>
        ...
        <Row>
          ...
          <Col md={4}>
            <Card className="mx-2 my-3">
              ...
              <Card.Body>
                <Card.Text>
                  <p>Costi e convenienza</p>I campeggi generalmente hanno tariffe di pernottamento significativamente
                  più basse rispetto ad hotel o villaggi offrendo servizi molto simili.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4}>
            <Card className="mx-2 my-3">
              ...
              <Card.Body>
                <Card.Text>
                  <p>Accessibilità</p>I campeggi sono facilmente raggiungibili, con parcheggi e sentieri ben segnalati,
                  e offrono mappe, informazioni turistiche e suggerimenti su escursioni e attrazioni locali.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
